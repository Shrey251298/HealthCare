        ...
        <div class="container-fluid">
           <div class="row">
                        <div class="col-md-12">
                            <div class="tabbable-line">
                               <ul class="nav nav-pills nav-pills-rose" style="height: 100px;">
									<li><a href="#" class="list-btn" id="listview">Health Product</a></li>
										
									<li><a href="#" class="list-btn" id="gridview">Medicine</a></li>
					    ...
					    <div class="col-md-12">
                                                ...
                                                <div>
                                                    <table  id="example4"  data-toggle="table" data-search="true" data-pagination="true">
                                                        <thead  style="color: black">
                                                            <tr>
					                        <th>Health Product Id</th>
                                                                <th>Health Product Name</th>
					                        <th>Health Product Price</th>
					                        <th>Health Product Description</th>
					                        <th> Action </th>
                                                                <th> Action </th>
					                    </tr>
					                </thead>
							...
							<%
                                                          ResultSet rstd=insertcommand("select * from healthproduct_table");
                                                                while(rstd.next()){
                                                                    String filename=rstd.getString("hp_filename");
                                                                    out.println("<tr>"
                                                                        + "<td>"+rstd.getString(1)+"</td>"
                                                                        + "<td>"+rstd.getString(2)+"</td>"
                                                                        + "<td>"+rstd.getString(3)+"</td>"
                                                                        + "<td>"+rstd.getString(4)+"</td>"          
                                                                        + "<td><form action='accept_appointment.jsp' method='GET'><input type='hidden' value='a' name='selector'><input type='hidden' value='"+rstd.getString(2)+"' name='id'><button class='btn btn-primary' name='submit' value='accept' type='submit' style='padding: 6px 10px 10px 10px;border-radius: 50%;'><i class='fa fa-check' aria-hidden='true'></i></button></form></td>" 
                                                                        + "<td><form action='accept_appointment.jsp' method='GET'><input type='hidden' value='r' name='selector'><input type='hidden' value='"+rstd.getString(2)+"' name='id'><button class='btn btn-danger' name='submit' value='reject' type='submit' style='padding: 6px 10px 10px 10px;border-radius: 50%;'><i style='color:#fff' class='fa fa-times' aria-hidden='true'></i></button></form></td>"        
                                                                        + "</tr>");
                                                                            }
                                                        %>						
							</tbody>
					    ...
					    <div class="col-md-12">
					                        ...
					                        <th> Action </th>
                                                        ...
                                                        <tbody style="color: black" id="mylocation">   
							<%
                                                          ResultSet rst=insertcommand("select * from medicine_table");
                                                                while(rst.next()){
                                                                    String filename=rst.getString("m_filename");
                                                                    out.println("<tr>"
                                                                        + "<td>"+rst.getString(1)+"</td>"
                                                                        + "<td>"+rst.getString(2)+"</td>"
                                                                        + "<td>"+rst.getString(3)+"</td>"
                                                                        + "<td>"+rst.getString(4)+"</td>"          
                                                                        + "<td><form action='accept_appointment.jsp' method='GET'><input type='hidden' value='a' name='selector'><input type='hidden' value='"+rst.getString(2)+"' name='id'><button class='btn btn-primary' name='submit' value='accept' type='submit' style='padding: 6px 10px 10px 10px;border-radius: 50%;'><i class='fa fa-check' aria-hidden='true'></i></button></form></td>" 
                                                                        + "<td><form action='accept_appointment.jsp' method='GET'><input type='hidden' value='r' name='selector'><input type='hidden' value='"+rst.getString(2)+"' name='id'><button class='btn btn-danger' name='submit' value='reject' type='submit' style='padding: 6px 10px 10px 10px;border-radius: 50%;'><i style='color:#fff' class='fa fa-times' aria-hidden='true'></i></button></form></td>"        
                                                                        + "</tr>");
                                                                            }
                                                        %>						
							</tbody>
