...
<%  String pics=(String)session.getAttribute("doctorid"); %>
<html>
<head>
<meta charset="UTF-8">
                    ...
                    <div class="row">
                        <div class="col-10" style="margin: 50px 90px ;">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input type="text" name="doctorname" class="form-control" value="<%=pics%>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <label style="color:#000;">Medicine Name</label>
                                </div>
                                <div class="col-6">
