...
<%!
    ResultSet insertcommand(String cmd){
        ...
        try {
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/e_healthcare_system", "root", "tigre");
        ...
        <div class="user-info">
            ...
            <div class="admin-action-info"> <span>Welcome</span>
                                ...
                                <%
                                    try{
                                    Class.forName("com.mysql.jdbc.Driver");
                                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/e_healthcare_system","root","tigre");
