                                        ...
                                        <div class="row">
					                        <div class="col-md-12">
					                            <div class="container bg-white p-5">
					                                  <div >
					                                    <table data-toggle="table" data-search="true" data-pagination="true" id="example4">
					                                        <thead>
					                                            <tr>
					                                            	<th></th>
                                                                                        <th> Id </th>
					                                                ...
					                                                <th> Action </th>
                                                                                ...
                                                                                <tbody id="mylocation" style="color: black"> 
											<%
                                                                                            ResultSet rst=insertcommand("select * from paitent_reg");
                                                                                            while(rst.next()){
                                                                                                out.println("<tr>"
                                                                                                        +"<td></td>"
                                                                                                        ...
                                                                                                        +"<td><a href='update1.jsp?fname="+rst.getString(4)+"&lname="+rst.getString(5)+"&bod="+rst.getString(6)+"&gender="+rst.getString(7)+"&contact="+rst.getString(8)+"&country="+rst.getString(9)+"&address="+rst.getString(10)+"&email="+rst.getString(2)+"'>Update</a></td>"
                                                                                                        +"<td><form action='patient_list_delete' method='post'><input type='hidden' name='email' value='"+rst.getString(2)+"'><input type='submit' value='delete'></form></td>"          
                                                                                                        + "</tr>");
                                                                                            }
                                                                                         %>					
										</tbody>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="container p-5">
                                                        ...
                                                        <div class="row">     
                                                        <%
                                                            ResultSet rd=insertcommand("select * from paitent_reg");
                                                            while(rd.next()){
                                                                ...
                                                                out.print("<h3 class='card-title'>"+rd.getString(4)+"</h3>");
                                                                out.print("<p class='card-text'>"+rd.getString(7)+"</p>");
                                                                out.print("<p class='card-text'>"+rd.getString(10)+"</p>");
                                                                 out.print("<p class='card-text'>"+rd.getString(2)+"</p>");
                                                                out.print("</div>");
                                                                out.println("<div class='footer'>");
                                                                out.println("<a href='update1.jsp?fname="+rd.getString(4)+"&lname="+rd.getString(5)+"&bod="+rd.getString(6)+"&gender="+rd.getString(7)+"&contact="+rd.getString(8)+"&country="+rd.getString(9)+"&address="+rd.getString(10)+"&email="+rd.getString(2)+"'>Update</a>");
                                                                out.print("<form action='patient_list_delete' method='post'><input type='hidden' name='email' value='"+rd.getString(2)+"'><input type='submit' value='delete'></form>");
                                                                out.println("</div>");
                                                                out.println("</div>");
                                                                out.println("</div>");
