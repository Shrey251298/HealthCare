    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active open"><a href="paitent_dashboard.jsp"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
                ...
                <section class="boxs-simple">
                    <div class="profile-header">
                        <div class="profile_info">
                            ...
                            <span class="text-muted col-white">Paitent</span>
                            <div class="mt-10">
                                <form action="PatientUploadImage" method="post" enctype="multipart/form-data">
                                ...
                                <div class="profile-desc">
                                        ...
                                        <ul class="list-group list-group-unbordered">
                                            ...
                                            <li class="list-group-item">
                                             ...
                                             <li class="list-group-item">
                                                <b> Contact :</b>
                                                <div class="profile-desc-item pull-right ml-3"><%=ad.getString(8)%></div>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Address :</b>
                                                <div class="profile-desc-item pull-right ml-3"><%=ad.getString(10)%></div>
                                            </li>
                                        </ul>
