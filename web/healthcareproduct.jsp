...
<link href="assets/css/card-product.css" rel="stylesheet">
...
<nav class="navbar clearHeader">
    <div class="col-12">
        <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand" href="index.html">Healthcare</a> </div>
    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Product</span> </a>
                    <ul class="ml-menu">
...
<section class="content home">
    <div class="container-fluid">
       <div class="block-header">
            <h2>Buy Healthcare Product</h2>
            <small class="text-muted">Buy Best Healthcare Product From This System.</small>
        </div>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="row">
                    <%
                                                            ResultSet rd=insertcommand("select * from healthproduct_table");
                                                            while(rd.next()){
                                                                String filename = rd.getString("hp_filename");
                                                                out.print("<div class='col-sm-4  mt-3'>");
