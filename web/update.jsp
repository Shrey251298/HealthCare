...
String mcino=request.getParameter("mcino");
           ...
           <div class="row">
                    ...
                    <div class="row">
                        <div class="col-10" style="margin: 50px 90px ;">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <label style="color:#000;">M.C.I No</label>
                                </div>
                                <div class="col-6">
                                    <input type="text" value="<%=mcino%>" class="form-control" required readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2">
                                    <label style="color:#000;">Clinic Name</label>
                                </div>
                                <div class="col-6">
                                    <input type="text" name="cln" value="<%=cln%>" class="form-control" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2">
                                    <label style="color:#000;">Clinic No</label>
                                </div>
                                <div class="col-6">
                                    <input type="text" name="clno" value="<%=clno%>" class="form-control" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2">
                                    <label style="color:#000;">Degree</label>
                                </div>
                                <div class="col-6">
                                    <input type="text" name="degree" value="<%=degree%>" class="form-control" required >
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2">
                                    <label style="color:#000;">Work Of Experience</label>
                                </div>
                                <div class="col-6">
                                    <input type="text" name="workofexperience" value="<%=woe%>" class="form-control" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2">
                                ...
                                <div class="col-6">
                                    <input type="text"  value="<%=dp%>" class="form-control" required readonly> 
                                </div>
                            </div>    
                            <div class="row">
                                <div class="col-4">
